...
if __name__ == '__main__':
    ...
    x = np.load('../data/tests/Missing/[test0.5]X_train0.50.npy')
    y = np.load('../data/tests/Missing/[test0.5]y_train0.50.npy')
    # print(tabulate(x))
    # print(y)
    print(x.shape, y.shape)

    x = np.load('../data/tests/Missing/[test0.3]X_train0.20.npy')
    y = np.load('../data/tests/Missing/[test0.3]y_train0.20.npy')
    # print(tabulate(x))
    # print(y)
    print(x.shape, y.shape)

    x = np.load('../data/tests/Missing/[test0.5]X_test0.50.npy')
    y = np.load('../data/tests/Missing/[test0.5]y_test0.50.npy')
    # print(tabulate(x))
    # print(y)
    print(x.shape, y.shape)

    x = np.load('../data/tests/Missing/[test0.3]X_test0.20.npy')
    y = np.load('../data/tests/Missing/[test0.3]y_test0.20.npy')
    # print(tabulate(x))
    # print(y)
    print(x.shape, y.shape)